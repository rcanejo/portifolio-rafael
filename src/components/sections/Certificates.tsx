...
import { SinceDuration } from "@/components/motion/SinceDuration";
          ...
          <ul className="space-y-12">
            {certificates.map((cert, i) => (
              <Reveal key={`${cert.year}-${cert.course.pt}`} delay={i * 0.08}>
                <li className="relative grid gap-4 md:grid-cols-[1fr_auto] md:items-start">
                  <div className="relative pl-6">
                    ...
                    {cert.description && (
                      <p className="mt-3 max-w-prose text-sm leading-relaxed text-fg/85">
